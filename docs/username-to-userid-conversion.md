> **Archived.** This was the repository's TODO.md until 2026-09-20. It is a
> completion log for the username-to-user-ID conversion, not outstanding
> work -- every item in it is done. Kept for the history. Current work is in
> [TODO.md](../TODO.md).
